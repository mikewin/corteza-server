...
func (s Store) convertSettingFilter(f settings.Filter) (query squirrel.SelectBuilder, err error) {
...
//}
//
//func (s Store) UpdateSettings(ctx context.Context, value *Value) error {
...
//}
//
//func (s Store) SettingsLookupByName(ctx context.Context, name string, ownedBy uint64) (*settings.Value, error) {
//	var (
//		v   = &settings.Value{}
