...
func (j *composeModuleCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composeModuleUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composeModuleRemove) Do(ctx context.Context, s store.Interface) error {
