...
// corteza/store/credentials.yaml
...
func (j *credentialsCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *credentialsUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *credentialsRemove) Do(ctx context.Context, s store.Interface) error {
