...
func (j *composePageCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composePageUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composePageRemove) Do(ctx context.Context, s store.Interface) error {
