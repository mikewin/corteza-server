...
// corteza/store/compose_module_fields.yaml
...
func (j *composeModuleFieldCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composeModuleFieldUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composeModuleFieldRemove) Do(ctx context.Context, s store.Interface) error {
