...
func (j *userCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *userUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *userRemove) Do(ctx context.Context, s store.Interface) error {
