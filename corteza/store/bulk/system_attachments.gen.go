...
func (j *attachmentCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *attachmentUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *attachmentRemove) Do(ctx context.Context, s store.Interface) error {
