...
// corteza/store/compose_charts.yaml
...
func (j *composeChartCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composeChartUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composeChartRemove) Do(ctx context.Context, s store.Interface) error {
