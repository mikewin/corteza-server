...
func (j *roleCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *roleUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *roleRemove) Do(ctx context.Context, s store.Interface) error {
