...
func (j *applicationCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *applicationUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *applicationRemove) Do(ctx context.Context, s store.Interface) error {
