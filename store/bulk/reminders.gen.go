...
func (j *reminderCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *reminderUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *reminderRemove) Do(ctx context.Context, s store.Interface) error {
