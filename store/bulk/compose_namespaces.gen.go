...
func (j *composeNamespaceCreate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composeNamespaceUpdate) Do(ctx context.Context, s store.Interface) error {
...
func (j *composeNamespaceRemove) Do(ctx context.Context, s store.Interface) error {
