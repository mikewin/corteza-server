...
func (j *{{ unpubIdent $.Types.Singular }}Create) Do(ctx context.Context, s store.Interface) error {
...
func (j *{{ unpubIdent $.Types.Singular }}Update) Do(ctx context.Context, s store.Interface) error {
...
func (j *{{ unpubIdent $.Types.Singular }}Remove) Do(ctx context.Context, s store.Interface) error {
